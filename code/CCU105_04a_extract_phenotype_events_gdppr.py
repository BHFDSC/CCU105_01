...
diag_codelist = codelist_union.filter(f.col("terminology")=="snomed")
...
# All ckd, dialysis, and transplant events in GDPPR
...
spark.sql(f'drop table if exists {proj_params.dbc}.ccu105_phenotypes_gdppr_all_events')

# COMMAND ----------

gdppr_pheno_sel.write.mode("overwrite").saveAsTable(f'{proj_params.dbc}.ccu105_phenotypes_gdppr_all_events')

# COMMAND ----------

gdppr_pheno_sel_relaod = spark.table(f'{proj_params.dbc}.ccu105_phenotypes_gdppr_all_events')
